    ...
    public class PermissionService : IPermissionService
    {
        ...
        public async Task<MessageResponseModel> GetByIdService(int id)
        {
            ...
            try 
            {
                ...
                PermissionModel? dataPermission = Util.ConvertDataTableToList<PermissionModel>(res).FirstOrDefault();

                //map data json for fontend
                PermissionDataModel data = new PermissionDataModel();
                data.Permission = dataPermission;//data Permission main  
        ...
        public async Task<MessageResponseModel> SearchService(SearchPermissionModel data)
        {
            ...
            try
            {
                ...
                var recordData =  Util.ConvertDataTableToList<PermissionModel>(res.Item1);
                var countRows = res.Item2;
                var response = new PaginatedListModel<PermissionModel>(recordData, (int)countRows, data.PageNumber, data.PageSize);
